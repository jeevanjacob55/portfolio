...
const FRAGMENT_SHADER = `
  ...
  void main() {
    ...
    vec3 color = mix(vec3(0.68, 0.86, 0.96), vec3(0.98, 0.995, 1.0), whiteFlow * 0.78);
    color = mix(color, vec3(0.35, 0.70, 0.91), skyFlow * 0.42);
    ...
    color = mix(color, vec3(0.025, 0.62, 0.81), cyanFlow * 0.48);
    ...
    color = mix(color, vec3(0.19, 0.56, 0.83), electricFlow * 0.32);
    ...
    color = mix(color, vec3(0.12, 0.43, 0.63), centerFlow * 0.52);
